package ru.mirea.kartamysheva.toastapp;
...
public class ToastAppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast = Toast.makeText(getApplicationContext(),"Здравствуй MIREA!Картамышева Таисия Николаевна",Toast.LENGTH_SHORT);
